...
по корзине, lift к текущему отделу и история). Модель: CatBoost MultiClass на 89 признаках,
...
| **CatBoost MultiClass** | **0,317** | **0,625** | **0,515** |
| CatBoost YetiRank, подвыборка | 0,259 | 0,526 | 0,450 |
...
| CatBoost MultiClass | 0,677 | 0,637 | 0,601 | 0,599 | 0,632 | 0,478 |
...
- CatBoost обходит её везде, но на полпункта hit@3. Главные признаки: счётчики корзины и
...
- YetiRank на подвыборке остановился на 32-й итерации и проиграл, для честного сравнения ему
...
В браузере считается эвристика на тех же таблицах, что лежат в `results/`, CatBoost статический
сайт не запускает. Выигрыш модели показан офлайн.
...
make train      # бейзлайны и CatBoost, около часа на 12 потоках
